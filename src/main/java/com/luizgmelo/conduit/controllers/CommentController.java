...
public class CommentController {
  ...
  public ResponseEntity<MultipleCommentResponseDTO> listComments(@PathVariable String slug,
    ...
    MultipleCommentResponseDTO response = new MultipleCommentResponseDTO(commentDTOList);
    return ResponseEntity.status(HttpStatus.OK).body(response);
  }

  @PostMapping
  public ResponseEntity<CommentResponseDTO> sendComment(@PathVariable("slug") String slug, @Valid @RequestBody CommentRequestDto commentDto) {
